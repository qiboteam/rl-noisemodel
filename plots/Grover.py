...
parser.add_argument('--config', type=str, default=f'src/rlnoise/simulation_phase/3Q_random_Clifford(soft_noise_grover)/config_all_noise.json')
parser.add_argument('--model', type=str, default=f'src/rlnoise/simulation_phase/3Q_random_Clifford(soft_noise_grover)/3Q_Rand_clif_logmse175000_allNoise.zip')
