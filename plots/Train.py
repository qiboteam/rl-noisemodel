...
ax[1].plot(time_steps, trace_distance, linewidth=4, color='#e60049')
ax[1].plot(time_steps, eval_trace_distance, linewidth=4, color='#0bb4ff')
ax[1].fill_between(time_steps, trace_distance - trace_distance_std, 
...
ax[1].set(xlabel='Episodes/1000', ylabel='Trace Distance')
# set ylim
#ax[1].set_ylim([0, 0.3])
#ax[1].legend(['Train Set', 'Test Set'], loc='upper right')
