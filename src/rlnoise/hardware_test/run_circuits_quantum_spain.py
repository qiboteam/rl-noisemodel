...
benchmark_circ_path= "src/rlnoise/hardware_test/RB_quantum_spain/RB_set/" #"src/rlnoise/hardware_test/dm_1Q_quantum_spain/"

numbers = np.arange(1, 200, 20)
for number in numbers:
    bench_name='D'+str(number)+'_len20.npy'#'100_circ_set.npy'

    bench_results_path = "src/rlnoise/hardware_test/RB_quantum_spain/RB_set/"#"src/rlnoise/hardware_test/dm_1Q_quantum_spain/"
