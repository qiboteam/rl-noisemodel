...
benchmark_circ_path="src/rlnoise/hardware_test/new_datasets/RB_set/"
for number in [12,15,18,21,24,27,30]:
    bench_name='D'+str(number)+'_len50.npy'#'100_circ_set.npy'
    bench_results_path = "src/rlnoise/hardware_test/dm_1Q_quantum_spain/"
